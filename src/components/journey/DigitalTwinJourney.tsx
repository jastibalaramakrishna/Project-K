      ...
      <header className="h-14 border-b border-[var(--border-color)] bg-[var(--bg-panel)] px-4 sm:px-6 flex items-center justify-between shrink-0 z-30 shadow-sm">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <button
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[var(--bg-surface)] border border-[var(--border-color)] text-[10px] font-mono font-semibold text-[var(--text-secondary)] hover:text-amber-500 transition-colors"
